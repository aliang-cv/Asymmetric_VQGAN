...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--outdir",
        type=str,
        default="/data01/lxl_workspace/Asymmetric_VQGAN/output/git_results",
    ...
    parser.add_argument(
        "--indir",
        type=str,
        default="/data01/lxl_workspace/Asymmetric_VQGAN/output/my_dataset/val",
    ...
    parser.add_argument(
        "--ckpt_d",
        type=str,
        default="/data01/lxl_workspace/Asymmetric_VQGAN/output/pre_models/sd-v1-5-inpainting.ckpt",
